      ...
      <ul className='hidden md:flex items-start gap-5 font-medium'>
        ...
        <div className='flex items-center gap-4'>
        {
            token ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                ...
                <div className='absolute top-0 right-0 text-base font-medium pt-14 text-gray-600 z-20 hidden group-hover:block'>
         ...
         <div className={` ${showMenu?'fixed w-full':'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all duration-300`}>
          ...
          <ul className='flex flex-col items-center gap-2 mt-5 px-5 texlg font-medium'>
